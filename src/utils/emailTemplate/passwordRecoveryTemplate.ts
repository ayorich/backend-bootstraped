const passwordRecoveryTemplate = (firstName: string, url: string) => {
	const theEmail = `
    <html>
    <head>
      ...
      .button {
        ...
        border-top: 10px solid  #55c57a;
        border-right: 18px solid  #55c57a;
        border-bottom: 10px solid  #55c57a;
        border-left: 18px solid  #55c57a;
          ...
          <td align="center">
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
             ...
             https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                          ...
                          <p>If you did not request a password reset, please ignore this email or <a href="mailto:wolfsbane@gmail.com">contact support</a> if you have questions.</p>
                          <p>Thanks,
